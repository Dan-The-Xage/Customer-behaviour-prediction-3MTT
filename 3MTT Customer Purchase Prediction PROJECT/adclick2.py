...
try:
    ...
    if not isinstance(le, dict):
        st.error("Error: 'label_encoders.joblib' is not a dictionary. Please check the saved file.")
        st.stop()
except FileNotFoundError:
...
numerical_features = ["NumericalFeature1", "NumericalFeature2"]  # Update with actual feature names
